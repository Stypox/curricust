...
use crate::{printers::latex_printer::{LatexPrinter, write_latex_command_call}, attr::{context::Context, text_with_attributes::TextWithAttributes}, util::yaml::YamlConversions};
...
impl LatexPrinter for SkillsElement {
